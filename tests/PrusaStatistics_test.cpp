...
std::string itostr3(int i) { return std::to_string(i); }

std::string eeprom_read_word(uint16_t* /*i*/) { return "eeprom_read"; }
...
void SERIAL_ECHO(std::string s) { SERIAL_BUFFER += s; }

void SERIAL_ECHO(int i) { SERIAL_BUFFER += std::to_string(i); }

void SERIAL_ECHO(char c) { SERIAL_BUFFER += char(c); }

void SERIAL_ECHOLN(std::string s) { SERIAL_BUFFER += s + "\n"; }

void SERIAL_ECHOLN(char c) { SERIAL_BUFFER += char(c); }

void SERIAL_RESET() { SERIAL_BUFFER.clear(); }

struct MySerial {
        void print(int i) { SERIAL_ECHO(i); }

        void println() { SERIAL_ECHO("\n"); }
};
...
std::string SERIALS_SERIALIZE() { return old_code::SERIAL_BUFFER + "\n" + new_code::SERIAL_BUFFER; }
